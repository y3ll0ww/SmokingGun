...
urlpatterns = [
    ...
    # Get
    path('root/tree/<int:project>/', views.TreeView.as_view(), name='tree-root'),
    path('breadcrumbs/<str:item_type>/<int:item_id>/', views.BreadcrumbTrailView.as_view(), name='breadcrumbs'),
    path('project/<int:id>/', views.RootFolderDetailView.as_view(), name='root'),
    ...
    # Create
    path('projects/', views.ProjectsAllView.as_view(), name='projects-all'),
    ...
    # Update
    path('project/update/<int:pk>/', views.ProjectDetailView.as_view(), name='project-update'),
